...
const ReplyItem = ({
  ...
  >
    <ProfileAvatarLink person={entry.author} size="xs" className="mt-0.5 shrink-0 rounded-full" />
      ...
      >
        <div className="flex items-start justify-between gap-2">
          <Link to={`/app/profile/${entry.author.id}`} className="min-w-0">
            <p className="truncate text-[13px] font-semibold text-ink hover:underline">
        ...
        {editing ? (
          ...
          <p className="min-w-0 wrap-break-word text-[13px] leading-relaxed text-ink">
